...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "e2913b3c-c2cf-4293-a8a9-a5d15eb40e96");
        ...
        <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='contact'>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                ...
                <div className='my-6 text-left'> Message
                    <textarea className='w-full border border-gray-300 rounded py-3 px-4 h-48 resize-none' name="Message" id="" placeholder='Message' required></textarea>
                </div>
