...
const Foter = () => {
    return (
        <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Foter'>
            <div className='container mx-auto flex flex-col md:flex-row justify-between items-start text-white'>
                ...
                <div className='w-full md:w-1/5 mb-8 md:mb-0 ml-3.5'>
                ...
                <div className='flex gap-2'>
                    <input type="email" placeholder='enter your email' className='rounded p-2 bg-gray-800 text-gray-400 border border-gray-700 focus:outline-none w-full md:w-auto'/>
                    <button className='bg-blue-500 text-white px-4 py-2' >Subscribe</button>
                </div>
                </div>
            </div>
            <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
            Copyright 2024 © Hello Buddy. All Right Reserved.
